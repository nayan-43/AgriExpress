...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-8">
        <p class="text-xs text-gray-500 mb-6">
            <a href="{{ route('home') }}" class="hover:text-brand-700">Home</a> <i
        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div class="flex gap-4">
                ...
                <div class="flex-1 rounded-xl overflow-hidden bg-gray-50">
                    <img data-gallery-main src="{{ $product['gallery'][0] }}" class="w-full h-full object-cover">
                </div>
            </div>
            ...
            <div>
                ...
                <form action="{{ route('cart.add', $product['id']) }}" method="POST" class="flex items-center gap-3 mb-6">
                    @csrf
                    <div class="flex items-center border border-gray-200 rounded-md" data-qty data-min="1" data-max="10">
                ...
                <div class="flex items-center gap-6 text-sm text-gray-600 mb-8">
                    <button data-wishlist-btn class="hover:text-brand-700"><i class="fa-regular fa-heart"></i> Add to
                        Wishlist</button>
