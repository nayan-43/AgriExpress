...
@section('content')
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="grid lg:grid-cols-[1fr_360px] gap-8">
            <div>
                <div data-coupon-banner
                    class="bg-emerald-50 border border-emerald-200 text-emerald-700 text-sm rounded-md px-4 py-3 flex items-center justify-between mb-6 {{ $appliedCoupon ? '' : 'hidden' }}">
                    <span><i class="fa-solid fa-tag mr-2"></i>Coupon code "<span
                            data-coupon-code>{{ $appliedCoupon ?? 'WELCOME10' }}</span>" applied! {{ $discountPct }}%
                        off</span>
                    <button type="button" data-coupon-dismiss class="text-emerald-700 hover:text-emerald-900"><i
            ...
            <aside class="border border-gray-100 rounded-lg p-6 h-fit">
                ...
                <div class="space-y-2 text-sm text-gray-600 mb-4">
                    ...
                    <div class="flex justify-between text-emerald-600"><span>Discount
                            ({{ $appliedCoupon ?? 'WELCOME10' }})</span><span
                ...
                <form data-coupon-form class="flex gap-2 mb-5">
