...
@section('content')
    ...
    <section class="max-w-7xl mx-auto px-4 py-8 grid md:grid-cols-2 gap-6">
        @foreach ($promoBanners as $banner)
            <div class="relative rounded-xl overflow-hidden min-h-[240px] flex items-center">
    ...
    {{-- ============ Testimonials — single always-on slider ============ --}}
    {{-- ONE block only (no mobile/desktop duplicate), and all sizing is done in
     the scoped CSS below rather than Tailwind md: variants, so it can't end
     up rendering twice or wrapping onto a second row. --}}
    <section class="bg-brand-50 py-14 mt-8">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <h2 class="text-2xl font-bold text-gray-900">What Our Customers Say</h2>
            <p class="text-gray-500 text-sm mb-8">Real people. Real experiences.</p>

            <div class="se-slider" data-carousel data-autoplay="5000">
                <div class="se-slider__viewport">
                    <div class="se-slider__track" data-carousel-track>
                        @foreach ($testimonials as $t)
                            <div class="se-slider__slide" data-carousel-slide>
                ...
                <button type="button" class="se-slider__arrow se-slider__arrow--prev" data-carousel-prev
                    aria-label="Previous testimonial">
                    <i class="fa-solid fa-chevron-left text-xs"></i>
                </button>
                <button type="button" class="se-slider__arrow se-slider__arrow--next" data-carousel-next
                    aria-label="Next testimonial">
                    <i class="fa-solid fa-chevron-right text-xs"></i>
                </button>

                <div class="se-slider__dots" data-carousel-dots></div>
            </div>
        </div>
    </section>
