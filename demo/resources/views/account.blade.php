    ...
    <div class="max-w-7xl mx-auto px-4 py-8 grid lg:grid-cols-[240px_1fr] gap-8">
        ...
        <aside class="border border-gray-100 rounded-lg p-4 h-fit">
            ...
            <nav class="space-y-1 text-sm">
                ...
                <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-md text-gray-600 hover:bg-gray-50"><i
        ...
        <div>
            ...
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="#" class="text-brand-700 text-sm font-medium hover:underline">View All <i
