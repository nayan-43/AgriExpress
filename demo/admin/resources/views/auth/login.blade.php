{{--
  ...
  Controller: return view('auth.login') from a GET /login route.
  On submit, POST to route('login') and validate email/password there.
--}}
    ...
    <div class="min-h-screen lg:flex">
        ...
        <div
            ...
            <div class="relative flex items-center gap-3">
                <div
                    class="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 grid place-items-center shadow-lg shadow-blue-900/40">
                ...
                <form action="{{ route('login') }}" method="POST"
                    ...
                    <div class="flex flex-col items-center text-center">
                        <div class="flex items-center gap-2.5">
                            <div
                                class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 grid place-items-center text-white">
                    ...
                    <div class="flex items-center gap-3 justify-center text-center">
                        <span class="w-9 h-9 rounded-full bg-blue-50 text-blue-600 grid place-items-center shrink-0"><i
